...
# [START gke_mongodb_vpc_multi_region_network]
module "gcp-network" {
...
# [END gke_mongodb_vpc_multi_region_network]

# [START gke_mongodb_cloudnat_simple_create]
module "cloud_router" {
...
# [END gke_mongodb_cloudnat_simple_create]
